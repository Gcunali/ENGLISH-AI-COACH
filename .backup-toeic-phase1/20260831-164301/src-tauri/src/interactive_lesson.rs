use crate::interactive_exercise::{ExerciseItem, GuidedExerciseStageDto};
...
pub const GUIDED_CONVERSATION_STAGE_SCHEMA_VERSION: u32 = 1;
pub const GUIDED_CONVERSATION_POLICY_VERSION: u32 = 1;
pub const GUIDED_CONVERSATION_CONTEXT_VERSION: u32 = 1;
pub const GUIDED_CONVERSATION_TURN_SCHEMA_VERSION: u32 = 1;
pub const GUIDED_CONVERSATION_COMPLETION_RESULT_VERSION: u32 = 1;
...
impl InteractiveStageType {
    ...
    pub fn runtime_available(self, schema_version: u32) -> bool {
        schema_version == 1
            ...
            && (self != Self::GuidedConversation
                || schema_version == GUIDED_CONVERSATION_STAGE_SCHEMA_VERSION)
    }
}
...
pub enum ActiveStageContentDto {
    ...
    Listening {
        ...
        #[serde(rename = "revealTextAfterFirstPlay")]
        reveal_text_after_first_play: bool,
    },
    Repeat {
    ...
    GuidedConversation {
        scenario: String,
        #[serde(rename = "studentRole")]
        student_role: String,
        #[serde(rename = "teacherRole")]
        teacher_role: String,
        goal: String,
        #[serde(rename = "targetVocabulary")]
        target_vocabulary: Vec<String>,
        #[serde(rename = "targetExpressions")]
        target_expressions: Vec<String>,
        #[serde(rename = "minimumStudentTurns")]
        minimum_student_turns: u32,
        #[serde(rename = "recommendedStudentTurns")]
        recommended_student_turns: u32,
        #[serde(rename = "maximumStudentTurns")]
        maximum_student_turns: u32,
        started: bool,
        #[serde(rename = "studentTurnCount")]
        student_turn_count: u32,
        #[serde(rename = "assistantTurnCount")]
        assistant_turn_count: u32,
        turns: Vec<GuidedConversationTurnDto>,
    },
    Analysis {},
}
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GuidedConversationTurnDto {
    pub id: String,
    pub sequence_index: u32,
    pub role: String,
    pub text: String,
...
pub enum GuidedStageRuntimeState {
    ...
    Exercise {
        current_exercise_index: u32,
        items: Vec<ExerciseItemState>,
    },
}
