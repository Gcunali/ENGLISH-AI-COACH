...
export function ProgressPage() {
  ...
  if (!query.data || query.data.analyzedLessonCount === 0 || !query.data.averages) return <><PageHeader /><div className="mb-5"><PlacementSummaryCard /></div><EmptyState title="No analyzed lessons yet" message="Complete an analyzed lesson to start tracking progress." /><RecurringMistakesSection /></>
