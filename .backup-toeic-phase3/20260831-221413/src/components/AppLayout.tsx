...
const ROUTE_TITLES: Array<[RegExp, string]> = [
  ...
  [/^\/toeic\/part2\/session\//, 'TOEIC Part 2'], [/^\/toeic\/part2\/results\//, 'TOEIC Part 2 Results'], [/^\/toeic\/session\//, 'TOEIC Part 1'], [/^\/toeic\/results\//, 'TOEIC Part 1 Results'], [/^\/toeic\/history$/, 'TOEIC Performance'], [/^\/toeic$/, 'TOEIC Preparation'],
]
