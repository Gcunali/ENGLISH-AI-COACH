...
export const useConversationStore = create<ConversationStore>((set, get) => ({
  state: 'IDLE', messages: [], lesson: null, correctionCandidates: [], summary: null, voiceEngineState: 'stopped', analysis: null, analysisStatus: null, analysisError: null, analysisAutoEligible: false, metrics: null, error: null,
  transition: (next) => {
  ...
  reset: () => set({ state: 'IDLE', messages: [], lesson: null, correctionCandidates: [], summary: null, voiceEngineState: 'stopped', analysis: null, analysisStatus: null, analysisError: null, analysisAutoEligible: false, metrics: null, error: null }),
