...
export async function startToeicFullListening(
  ...
  return invoke("start_toeic_full_listening", { mode });
}
...
export async function startToeicFullReading(
  ...
  return invoke("start_toeic_full_reading", { mode });
}
...
export async function startToeicFullLr(): Promise<ToeicFullLrSession> {
  return invoke("start_toeic_full_lr");
}
