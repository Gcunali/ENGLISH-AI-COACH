...
import type { ConversationState, CorrectionCandidate, Lesson, LessonSummary, PipelineMetrics, TranscriptMessage, VoiceEngineEvent, VoiceEngineState } from '../types'
...
export const useConversationStore = create<ConversationStore>((set, get) => ({
  state: 'IDLE', messages: [], lesson: null, correctionCandidates: [], summary: null, voiceEngineState: 'stopped', metrics: null, error: null,
  transition: (next) => {
  ...
  reset: () => set({ state: 'IDLE', messages: [], lesson: null, correctionCandidates: [], summary: null, voiceEngineState: 'stopped', metrics: null, error: null }),
