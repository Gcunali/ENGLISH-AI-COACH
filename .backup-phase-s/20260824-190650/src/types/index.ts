...
export interface PronunciationAttempt { id:string; status:PronunciationStatus; sourceType:'custom'|'vocabulary'|'diagnostic'; sourceId:string|null; targetText:string; locale:'en-US'; overallScore:number|null; confidence:PronunciationConfidence|null; contentMatchScore:number|null; alignmentCoverage:number|null; audioDurationMs:number|null; createdAt:string; completedAt:string|null; words:PronunciationWordResult[] }
...
export type GuidedActiveContent = {kind:'theory';blocks:TheoryBlock[]}|{kind:'visual_vocabulary';items:VisualVocabularyItem[]}
