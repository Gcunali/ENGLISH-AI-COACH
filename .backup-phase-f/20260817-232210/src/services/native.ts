...
import type { CorrectionCandidate, Diagnostics, Lesson, LessonAnalysis, LessonSummary, LocalVoiceEngineProbe, OllamaModel, StartLessonResult, TranscriptMessage, VoiceEngineEvent, VoiceEngineStatus } from '../types'
