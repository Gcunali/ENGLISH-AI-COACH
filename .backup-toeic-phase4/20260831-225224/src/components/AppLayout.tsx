import { Activity, Award, BookOpen, ChevronDown, CircleGauge, ClipboardCheck, Dumbbell, FileCheck2, GraduationCap, History, Home, Mic2, RefreshCw, Settings, Sparkles, UserRound } from 'lucide-react'
...
const NAVIGATION = [
  ...
  { label: 'Exam preparation', items: [
    { to: '/toeic', label: 'TOEIC', icon: FileCheck2 },
  ] },
  { label: 'System', items: [
...
const ROUTE_TITLES: Array<[RegExp, string]> = [
  ...
  [/^\/toeic\/part3\/session\//, 'TOEIC Part 3'], [/^\/toeic\/part3\/results\//, 'TOEIC Part 3 Results'], [/^\/toeic\/part2\/session\//, 'TOEIC Part 2'], [/^\/toeic\/part2\/results\//, 'TOEIC Part 2 Results'], [/^\/toeic\/session\//, 'TOEIC Part 1'], [/^\/toeic\/results\//, 'TOEIC Part 1 Results'], [/^\/toeic\/history$/, 'TOEIC Performance'], [/^\/toeic$/, 'TOEIC Preparation'],
]
