...
vi.mock('../components/ReviewOverviewCard', () => ({ ReviewOverviewCard: () => <section aria-label="Review Activity">Review Activity</section> }))
...
describe('ProgressPage', () => {
  ...
  it('renders the zero-analysis empty state', () => {
    ...
    expect(screen.getByLabelText('Review Activity')).toBeInTheDocument()
  })
