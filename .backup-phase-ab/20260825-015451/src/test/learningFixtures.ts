...
export const vocabularyDetails: VocabularyItemDetails = {
  ...
  occurrences: [{ lessonId: lesson.id, sourceType: 'standard', lessonDate: lesson.startedAt, example: "I'm terrible at math.", occurrenceCount: 1 }],
}
...
export const recurringMistakeDetails: RecurringMistakeDetails = {
  ...
  occurrences: [
    { lessonId: lesson.id, sourceType: 'standard', lessonDate: lesson.startedAt, original: 'I am terrible cooking.', corrected: "I'm terrible at cooking.", explanation: "Use 'at'." },
    { lessonId: 'lesson-2', sourceType: 'standard', lessonDate: '2026-08-18T19:44:27.388Z', original: 'I am terrible cooking.', corrected: "I'm terrible at cooking.", explanation: "Use 'at'." },
  ],
}
