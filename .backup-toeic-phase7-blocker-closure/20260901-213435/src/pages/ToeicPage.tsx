        ...
        <div className="section-header">
          ...
          <div className="toeic-result-actions">
            <button
              ...
              onClick={() => nav("/toeic/listening")}
            >
              <Clock3 />
              Full Listening Simulation
            </button>
            <button className="button-primary" onClick={()=>nav('/toeic/reading')}><BookOpenCheck/>Full Reading Simulation</button>
            <button className="button-secondary" onClick={()=>nav('/toeic/full')}><Check/>Full Listening & Reading</button>
            <button
