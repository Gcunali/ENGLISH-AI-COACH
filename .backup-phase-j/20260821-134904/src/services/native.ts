...
import type { CorrectionCandidate, DashboardSummary, Diagnostics, LearningMemorySummary, LearningMemorySyncResult, Lesson, LessonAnalysis, LessonDetails, LessonHistoryFilter, LessonHistoryPage, LessonModeDefinition, LessonStartRequest, LessonSummary, LocalVoiceEngineProbe, OllamaModel, ProgressOverview, RecurringMistake, RecurringMistakeDetails, StartLessonResult, StudentLearningSummary, TranscriptMessage, VocabularyFilter, VocabularyItem, VocabularyItemDetails, VocabularyPage, VocabularySort, VocabularyStatus, VocabularySummary, VoiceEngineEvent, VoiceEngineStatus } from '../types'
