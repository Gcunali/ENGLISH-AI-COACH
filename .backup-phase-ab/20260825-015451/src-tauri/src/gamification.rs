...
pub const ACHIEVEMENTS: &[AchievementDefinition] = &[
    ...
    AchievementDefinition {
        id: "a1_complete", version: 1, title: "A1 Course Level Complete",
        description: "Complete all Guided Lessons in the A1 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("a1"), hidden: false,
    },
    AchievementDefinition {
        id: "a2_complete", version: 1, title: "A2 Course Level Complete",
        description: "Complete all Guided Lessons in the A2 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("a2"), hidden: false,
    },
    AchievementDefinition {
        id: "b1_complete", version: 1, title: "B1 Course Level Complete",
        description: "Complete all Guided Lessons in the B1 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("b1"), hidden: false,
    },
    AchievementDefinition {
        id: "b2_complete", version: 1, title: "B2 Course Level Complete",
        description: "Complete all Guided Lessons in the B2 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("b2"), hidden: false,
    },
    AchievementDefinition {
        id: "c1_complete", version: 1, title: "C1 Course Level Complete",
        description: "Complete all Guided Lessons in the C1 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("c1"), hidden: false,
    },
    AchievementDefinition {
        id: "c2_complete", version: 1, title: "C2 Course Level Complete",
        description: "Complete all Guided Lessons in the C2 Course level.", category: "course",
        criterion: AchievementCriterion::GuidedLevelComplete("c2"), hidden: false,
    },
    AchievementDefinition {
        id: "english_course_complete", version: 1, title: "English Course Complete",
        description: "Complete all 288 Guided Lesson IDs in the English Course.", category: "course",
        criterion: AchievementCriterion::GuidedCourseComplete, hidden: false,
    },
];
