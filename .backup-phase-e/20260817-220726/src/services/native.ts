...
import type { CorrectionCandidate, Diagnostics, Lesson, LessonSummary, LocalVoiceEngineProbe, OllamaModel, StartLessonResult, TranscriptMessage, VoiceEngineEvent, VoiceEngineStatus } from '../types'
