import type { DashboardSummary, LearningMemorySummary, Lesson, LessonAnalysis, LessonDetails, LessonHistoryItem, ProgressOverview, RecurringMistake, RecurringMistakeDetails, TranscriptMessage, VocabularyItemDetails, VocabularyPage, VocabularySummary } from '../types'
