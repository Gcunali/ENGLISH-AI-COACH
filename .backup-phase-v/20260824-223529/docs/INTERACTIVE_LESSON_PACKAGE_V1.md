...
Guided text turns are stored separately from standard Lessons. Student audio and temporary Piper output are not retained. Guided corrections are intentionally not promoted to global Corrections, Recurring Mistakes, Learning Memory, Vocabulary, Review, CEFR, pronunciation, XP, streaks or achievements in v1. `analysis` remains unsupported.
