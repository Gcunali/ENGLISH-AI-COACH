...
fn finalize_guided_lesson_analysis(
    ...
    state.guided_analysis.finalize(&request)
}
...
fn select_guided_lesson_pronunciation_attempt(
    ...
    state.guided_lessons.select_pronunciation(&request)
}
...
fn submit_guided_lesson_exercise_attempt(
    ...
    state.guided_lessons.submit_exercise(&request)
}
...
fn select_guided_lesson_exercise_attempt(
    ...
    state.guided_lessons.select_exercise(&request)
}
